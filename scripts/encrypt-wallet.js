...
// o arquivo é inútil pra qualquer um que o veja).
//
// Uso:
//   node scripts/encrypt-wallet.js "C:\Users\Andre_Aragon\Downloads\Wallet_bronkalertdb.zip"
//
// Ele pede uma senha (escolha uma nova, não precisa ser a do banco nem a do wallet
// original — essa é só pra proteger o arquivo no repositório). Guarde essa senha:
// ela vira a variável de ambiente WALLET_DECRYPT_PASSPHRASE no Netlify.
//
...
async function main() {
  ...
  const passphrase = await askHidden("Escolha uma senha para proteger o wallet no repositório (guarde-a!): ");
